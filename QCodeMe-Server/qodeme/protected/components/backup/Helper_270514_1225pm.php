...
//    }
    ...
    public static function set_chat_push($type, $user_id, $chat_id, $tags)
    {
        $apiKey = Yii::app()->params['googleApiKey'];
...
//        }
    ...
    public static function set_favorite_push($type, $userIds, $chat_id)
    {
        $apiKey = Yii::app()->params['googleApiKey'];
        ...
        foreach($userIds as $userId)
        {
            ...
            $fields = array(
                ...
                'data' => array(
                    "type" => $type,
                    'chat_id' => $chat_id,
                    'number_of_favorites' => $numberOfFavorites,
                ),
            );
    ...
    public static function set_flagged_push($type, $userIds, $messageID, $numberOfFlagged)
    {
        $apiKey = Yii::app()->params['googleApiKey'];
    ...
    public static function chat_add_member_push($type, $userIds, $chatID, $numberOfMembers, $ChatType)
    {
        $apiKey = Yii::app()->params['googleApiKey'];
