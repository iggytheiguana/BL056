...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends
	...
	public IndicatorLayout mIndicatorIvTop;
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem,
		...
		if (getShowIndicatorInternal() && listviewState != SCROLL_STATE_FLING) {
	...
	protected int listviewState = SCROLL_STATE_IDLE;
	...
	public void updateIndicatorViewsVisibility() {
		if (null != mIndicatorIvTop && listviewState != SCROLL_STATE_FLING) {
