...
public abstract class JSONHandler {
    ...
    public abstract ArrayList<ContentProviderOperation> parse(JSONObject json) throws JSONException;
    ...
    public final void parseAndApply(JSONObject json) throws JSONException {
        try {
            final ContentResolver resolver = mContext.getContentResolver();
            ArrayList<ContentProviderOperation> batch = parse(json);
            resolver.applyBatch(QodemeContract.CONTENT_AUTHORITY, batch);
