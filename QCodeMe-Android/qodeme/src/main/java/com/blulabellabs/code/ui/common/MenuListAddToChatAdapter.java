...
public class MenuListAddToChatAdapter<E extends ContactListItemEntity> extends ArrayAdapter<E> {
...
//    protected SparseArray<T> viewMap = new SparseArray<T>();
    ...
    public MenuListAddToChatAdapter(Context context, int layoutResId, List<E> list) {
