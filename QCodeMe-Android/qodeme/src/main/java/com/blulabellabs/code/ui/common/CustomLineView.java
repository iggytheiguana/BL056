...
public class CustomLineView extends TextView {
...
//			canvas.drawCircle(getWidth() - 15, padding + (textSize), (textSize / 2)-2, mPaintCircle);//RADIUS = 7
...
//			canvas.drawCircle((textSize / 2)+2, padding +(textSize ), (textSize / 2)-2, mPaintCircle);
//			// canvas.drawBitmap(circle, 0,0,new Paint());
//		}
