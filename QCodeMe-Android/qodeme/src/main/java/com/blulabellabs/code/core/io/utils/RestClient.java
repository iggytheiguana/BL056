...
public interface RestClient {
    ...
    void chatSetInfo(long chatId, String title, Integer color,String tags,String description, Integer is_locked, String status, String chat_title, RestListener callback);
    ...
    void setFavorite(String date, long chatId, RestListener callback);
