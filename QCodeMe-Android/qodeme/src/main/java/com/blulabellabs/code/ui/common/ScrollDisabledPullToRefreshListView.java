 ...
 */
public class ScrollDisabledPullToRefreshListView extends PullToRefreshListView {
	...
	public ScrollDisabledPullToRefreshListView(Context context) {
		super(context);
	}

	public ScrollDisabledPullToRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public ScrollDisabledPullToRefreshListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs);
	}
