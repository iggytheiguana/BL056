 ...
 */
public class ContactAcceptHandler extends BaseResponseHandler<VoidResponse> {

    private long mId;

    public ContactAcceptHandler(Context context, long _id) {
        super(context);
        mId = _id;
    }
    ...
    private void parseContact(ArrayList<ContentProviderOperation> batch) {
        ...
        //builder.withValue(Contacts.CONTACT_STATE, Contacts.State.APPRUVED);
